...
const Health = (props) => {
  ...
  const getPhotos = async () => {
    ...
    const res = await fetch(
      `https://api.unsplash.com/collections/4315264/photos?page=${page}&per_page=10&client_id=xe9XHOwZZpeZ4zGNMg1Clm03MIaZ1s2x2Zpi1wLDD5c`,
    )
  ...
  const getPreviousPhotos = async () => {
    setLoading(true)
    const res = await fetch(
      `https://api.unsplash.com/collections/4315264/photos?page=${
        page - 1
